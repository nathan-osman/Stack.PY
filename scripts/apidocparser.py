...
class APIDocParser(object):
    ...
    _BASE_URL = 'http://api.stackexchange.com/docs'
    ...
    def _parse(self):
        ...
        '''
        root = self._load_page('/')
        for m in root.find_all('a', 'method-name'):
    ...
    def _parse_method(self, method):
        ...
        '''
        self._map['methods']['network'].append(method.string)
